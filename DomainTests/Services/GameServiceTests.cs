...
namespace Domain.Services.Tests
{
    ...
    public class GameServiceTests
    {
        ...
        public void AddGoalToGame()
        {
            ...
            var playerGoalsPriorGame = player.AllPresentableSeriesStats[series.SeriesDummy.Id].GoalCount;
            ...
            var playerGoalsAfterGame = player.AllPresentableSeriesStats[series.SeriesDummy.Id].GoalCount;
        ...
        public void AddAssistToGame()
        {
            ...
            var playerAssistsPriorGame = player.AllPresentableSeriesStats[series.SeriesDummy.Id].AssistCount;
            gameService.AddAssistToGame(game.Id, player.Id, 78);
            var gameAssistsAfterGame = game.Protocol.Assists.Count;
            var playerAssistsAfterGame = player.AllPresentableSeriesStats[series.SeriesDummy.Id].AssistCount;
        ...
        public void AddYellowCardToGame()
        {
            ...
            var playerYellowCardsPriorGame = player.AllPresentableSeriesStats[series.SeriesDummy.Id].YellowCardCount;
            gameService.AddYellowCardToGame(game.Id, player.Id, 78);
            var gameYellowCardsAfterGame = game.Protocol.Cards.Count;
            var playerYellowCardsAfterGame = player.AllPresentableSeriesStats[series.SeriesDummy.Id].YellowCardCount;
        ...
        public void AddRedCardToGame()
        {
            ...
            var playerRedCardsPriorGame = player.AllPresentableSeriesStats[series.SeriesDummy.Id].RedCardCount;
            gameService.AddRedCardToGame(game.Id, player.Id, 78);
            var gameRedCardsAfterGame = game.Protocol.Cards.Count;
            var playerRedCardsAfterGame = player.AllPresentableSeriesStats[series.SeriesDummy.Id].RedCardCount;
        ...
        public void AddPenaltyToGame()
        {
            ...
            var playerPenatliesPriorGame = player.AllPresentableSeriesStats[series.SeriesDummy.Id].PenaltyCount;
            gameService.AddPenaltyToGame(game.Id, player.Id, 78, true);
            var gamePenatliesAfterGame = game.Protocol.Penalties.Count;
            var playerPenatliesAfterGame = player.AllPresentableSeriesStats[series.SeriesDummy.Id].PenaltyCount;
        ...
        public void RemoveGoalFromGame()
        {
            ...
            var playerGoalsAfterRemove = player.AllPresentableSeriesStats[series.SeriesDummy.Id].GoalCount;
        ...
        public void RemoveAssistFromGame()
        {
            ...
            var playerAssistsAfterRemove = player.AllPresentableSeriesStats[series.SeriesDummy.Id].AssistCount;
        ...
        public void RemoveYellowCardFromGame()
        {
            ...
            var playerYellowCardsAfterRemove = player.AllPresentableSeriesStats[series.SeriesDummy.Id].YellowCardCount;
        ...
        public void RemoveRedCardFromGame()
        {
            ...
            var playerRedCardsAfterRemove = player.AllPresentableSeriesStats[series.SeriesDummy.Id].RedCardCount;
        ...
        public void RemovePenaltyFromGame()
        {
            ...
            var playerPenatliesAfterRemove = player.AllPresentableSeriesStats[series.SeriesDummy.Id].PenaltyCount;
        ...
        public void PenaltyAddsGoalIfPenaltyIsGoal()
        {
            ...
            var playerGoalsPriorPenalty = player.AllPresentableSeriesStats[series.SeriesDummy.Id].GoalCount;
            gameService.AddPenaltyToGame(game.Id, player.Id, 78,true);
            var gameGoalsAfterPenalty = game.Protocol.Goals.Count;
            var playerGoalsAfterAfterPenalty = player.AllPresentableSeriesStats[series.SeriesDummy.Id].GoalCount;
        ...
        public void IfPenaltyThatIsGoalIsRemovedGoalIsAlsoRemoved()
        {
            ...
            var playerGoalsPrioRemoveOfPenalty = player.AllPresentableSeriesStats[series.SeriesDummy.Id].GoalCount;
            gameService.AddPenaltyToGame(game.Id, player.Id, 78, true);
            gameService.RemovePenaltyFromGame(game.Id, player.Id, 78);
            var gameGoalsAfterRemoveOfPenalty = game.Protocol.Goals.Count;
            var playerGoalsAfterAfterRemovOfPenalty = player.AllPresentableSeriesStats[series.SeriesDummy.Id].GoalCount;
