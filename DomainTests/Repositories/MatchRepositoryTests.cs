...
namespace DomainTests.Repositories
{
    ...
    public class MatchRepositoryTests
    {
        ...
        {
            var match = new Match(new ArenaName("Ullevi"), Guid.NewGuid(), Guid.NewGuid(), new Series(new MatchDuration(new TimeSpan(0, 90, 0)), new NumberOfTeams(16)), new MatchDateAndTime(new DateTime(2016, 12, 20, 19, 30, 00)));
            var match2 = new Match(new ArenaName("Ullevi"), Guid.NewGuid(), Guid.NewGuid(), new Series(new MatchDuration(new TimeSpan(0, 90, 0)), new NumberOfTeams(16)), new MatchDateAndTime(new DateTime(2016, 12, 20, 19, 30, 00)));
